package adventure_game_item_test
...
func TestCreateOne(t *testing.T) {
	...
	tests := []struct {
		name   string
		rec    func(d harness.Data, t *testing.T) *adventure_game_record.AdventureGameItem
		hasErr bool
	}{
		{
			name: "Without ID",
			rec: func(d harness.Data, t *testing.T) *adventure_game_record.AdventureGameItem {
				...
				return &adventure_game_record.AdventureGameItem{
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			r := h.Domain.(*domain.Domain).AdventureGameItemRepository()
...
func TestGetOne(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "With ID",
			id: func(d harness.Data, t *testing.T) string {
				rec, err := d.GetAdventureGameItemRecByRef(harness.GameItemOneRef)
