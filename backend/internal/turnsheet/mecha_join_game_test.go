...
func TestMechaJoinGameProcessor_GenerateTurnSheet(t *testing.T) {
...
func TestMechaJoinGameProcessor_GenerateTurnSheet_HTMLContainsInputElements(t *testing.T) {
	cfg, l, _, _, _ := testutil.NewDefaultDependencies(t)
	cfg.TemplatesPath = "../../templates"
...
func TestMechaJoinGameProcessor_GenerateTurnSheet_PreFillsAccountEmail(t *testing.T) {
	cfg, l, _, _, _ := testutil.NewDefaultDependencies(t)
	cfg.TemplatesPath = "../../templates"
...
func TestMechaJoinGameProcessor_GenerateTurnSheet_WithDeliveryMethods(t *testing.T) {
	cfg, l, _, _, _ := testutil.NewDefaultDependencies(t)
	cfg.TemplatesPath = "../../templates"
...
func TestMechaJoinGameScanData_Validate(t *testing.T) {
	tests := []struct {
		name      string
		data      turnsheet.MechaJoinGameScanData
		expectErr string
	}{
		{
			name: "missing email",
