...
// MechaSquadManagementFixture returns the sample rendering fixture for the
// mecha squad management turn sheet.
func MechaSquadManagementFixture() DevFixture {
	return DevFixture{
		TemplatePath:   "turnsheet/mecha_squad_management.template",
		OutputBaseName: "mecha_squad_management_turnsheet",
		...
		NewProcessor: func(l logger.Logger, cfg config.Config) (TurnSheetProcessor, error) {
			return NewMechaSquadManagementProcessor(l, cfg)
		},
	}
}
