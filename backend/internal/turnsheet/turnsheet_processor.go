...
type DocumentGenerator interface {
	...
	// GeneratePreviewData generates dummy data for a turn sheet preview
	// gameRec: The game record to generate preview data for
	// backgroundImage: Optional background image URL to include in the preview
	// Returns: JSON-encoded sheet data for the preview
	GeneratePreviewData(ctx context.Context, l logger.Logger, gameRec *game_record.Game, backgroundImage *string) ([]byte, error)
}
