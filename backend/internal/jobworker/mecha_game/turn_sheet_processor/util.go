...
//
//	mecha_game_squad_instance.game_subscription_instance_id
//	  -> game_subscription_instance.game_subscription_id
//	  -> game_subscription.account_user_id
func squadInstanceAccountUser(d *domain.Domain, squadInstance *mecha_game_record.MechaGameSquadInstance) (*account_record.AccountUser, error) {
