...
// DocumentRenderer renders turn sheet templates to HTML, PDF, and PNG.
...
func NewDocumentRenderer(l logger.Logger) (*DocumentRenderer, error) {
	l = l.WithFunctionContext("NewDocumentRenderer")

	l.Info("creating document renderer")
...
func (g *DocumentRenderer) SetTemplatePath(path string) {
	g.templatePath = path
}

// SetOutputDir sets the output directory
func (g *DocumentRenderer) SetOutputDir(dir string) {
	g.outputDir = dir
}

// GenerateHTML generates HTML from a template
func (g *DocumentRenderer) GenerateHTML(ctx context.Context, templatePath string, data any) (string, error) {
	l := g.logger.WithFunctionContext("DocumentRenderer/GenerateHTML")
...
func (g *DocumentRenderer) GeneratePDF(ctx context.Context, templatePath string, data any) ([]byte, error) {
	l := g.logger.WithFunctionContext("DocumentRenderer/GeneratePDF")
...
func (g *DocumentRenderer) GeneratePDFToFile(ctx context.Context, templatePath string, data any, filename string) error {
	l := g.logger.WithFunctionContext("DocumentRenderer/GeneratePDFToFile")
...
func (g *DocumentRenderer) loadTemplate(templatePath string) (*template.Template, error) {
	l := g.logger.WithFunctionContext("DocumentRenderer/loadTemplate")
...
func (g *DocumentRenderer) htmlToPDF(ctx context.Context, html string) ([]byte, error) {
	l := g.logger.WithFunctionContext("DocumentRenderer/htmlToPDF")
