...
-- Temporarily allow the catalog to show game instances that are 'started' in addition to 'created'.
-- Superseded by 20260319090000 which reverts this back to 'created' only.
...
WHERE gi.status IN ('created', 'started')
