-- Fix all three new views to include the four standard columns:
-- id, created_at, updated_at, deleted_at
--
-- CREATE OR REPLACE VIEW cannot reorder or rename columns, so we must
-- DROP then CREATE each view.
