...
-- Mapping table for adventure game character instances
CREATE TABLE adventure_game_character_instance_turn_sheet (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_adventure_game_character_instance_turn_sheet_character ON adventure_game_character_instance_turn_sheet(adventure_game_character_instance_id);
CREATE INDEX idx_adventure_game_character_instance_turn_sheet_turn_sheet ON adventure_game_character_instance_turn_sheet(game_turn_sheet_id);
...
COMMENT ON TABLE adventure_game_character_instance_turn_sheet IS 'Mapping table linking adventure game character instances to turn sheets';
