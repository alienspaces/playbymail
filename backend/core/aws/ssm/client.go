...
type NewFn func(context.Context, logger.Logger, Config) (secretor.SSM, error)

var _ secretor.SSM = &Client{}
var _ NewFn = New
...
func New(ctx context.Context, l logger.Logger, cfg Config) (secretor.SSM, error) {
	c := &Client{
		log: l,
	}
	l = c.logger("New")
	...
	c.client = ssm.NewFromConfig(awscfg)
