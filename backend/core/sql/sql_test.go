			...
			opts: &Options{
				Params: []Param{
					...
					},
					{
						Col:   "string_array_field_slice_multiple",
						Op:    OpLikeAny,
						Array: convert.GenericSlice([]string{"x", "y"}),
					},
					{
						Col:   "string_array_field_slice_multiple",
						Op:    OpILikeAny,
						Array: convert.GenericSlice([]string{"X", "Z"}),
					},
					{
...
AND CAST(string_array_field_slice_multiple AS TEXT) LIKE ANY (array[@string_array_field_slice_multiple2ArrayOp0,@string_array_field_slice_multiple2ArrayOp1])
AND CAST(string_array_field_slice_multiple AS TEXT) ILIKE ANY (array[@string_array_field_slice_multiple3ArrayOp0,@string_array_field_slice_multiple3ArrayOp1])
...
AND CAST(string_field_single AS TEXT) ILIKE @string_field_single2
AND CAST(string_field_single AS TEXT) LIKE @string_field_single3
...
`,
			expectParams: map[string]any{
				...
				"string_array_field_slice_multiple2ArrayOp0": "x",
				"string_array_field_slice_multiple2ArrayOp1": "y",
				"string_array_field_slice_multiple3ArrayOp0": "X",
				"string_array_field_slice_multiple3ArrayOp1": "Z",
				"string_array_field_single0":                 "d",
				"string_array_field_single1":                 "e",
				"string_field_single0":                       "e",
				"string_field_single1":                       "f",
				"string_field_single2":                       "e",
				"string_field_single3":                       "e",
