...
// GameItemInstanceResponseData -
type GameItemInstanceResponseData struct {
	ID                      string     `json:"id"`
...
type GameItemInstanceResponse struct {
	Data       *GameItemInstanceResponseData `json:"data"`
	Error      *ResponseError                `json:"error,omitempty"`
	Pagination *ResponsePagination           `json:"pagination,omitempty"`
}

type GameItemInstanceCollectionResponse struct {
	Data       []*GameItemInstanceResponseData `json:"data"`
	Error      *ResponseError                  `json:"error,omitempty"`
	Pagination *ResponsePagination             `json:"pagination,omitempty"`
}

type GameItemInstanceRequest struct {
	Request
	GameID                  string `json:"game_id"`
	GameItemID              string `json:"game_item_id"`
	GameInstanceID          string `json:"game_instance_id"`
