...
const icons = {
  ...
  states: () => h('svg', { viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', 'stroke-width': '2' }, [
    h('rect', { x: '3', y: '3', width: '18', height: '5', rx: '1' }),
    h('rect', { x: '3', y: '10', width: '18', height: '5', rx: '1' }),
    h('rect', { x: '3', y: '17', width: '18', height: '4', rx: '1' }),
  ]),
