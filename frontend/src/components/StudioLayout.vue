  ...
  <div class="studio-layout">
    ...
    <div v-else class="studio-shell">
      ...
      <div class="studio-header-wrapper">
        ...
        <button class="studio-burger icon-btn" @click="toggleStudioMenu" aria-label="Open studio menu" v-if="isMobile">
          <span></span>
          <span></span>
          <span></span>
        </button>
        <MainPageHeader title="Game Designer Studio" icon-type="pencil" icon-color="blue">
          <template #actions>
