...
export async function fetchComputerOpponents(gameId, params = {}) {
...
export async function createComputerOpponent(gameId, data) {
...
export async function updateComputerOpponent(gameId, opponentId, data) {
...
export async function deleteComputerOpponent(gameId, opponentId) {
  const res = await apiFetch(`${BASE(gameId)}/${encodeURIComponent(opponentId)}`, {
    method: 'DELETE',
