...
export async function fetchMechaGameSquads(gameId, params = {}) {
...
export async function createMechaGameSquad(gameId, data) {
...
export async function updateMechaGameSquad(gameId, squadId, data) {
...
export async function deleteMechaGameSquad(gameId, squadId) {
  const res = await apiFetch(`${BASE(gameId)}/${encodeURIComponent(squadId)}`, {
    method: 'DELETE',
