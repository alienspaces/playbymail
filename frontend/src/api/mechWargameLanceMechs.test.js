...
import { fetchLanceMechs, createLanceMech, updateLanceMech, deleteLanceMech } from './mechWargameLanceMechs'

describe('mechWargameLanceMechs API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('fetchLanceMechs', () => {
    it('calls GET /api/v1/mech-wargame-games/:gameId/lances/:lanceId/mechs and returns data with hasMore', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/v1/mech-wargame-games/game-1/lances/lance-1/mechs'),
  ...
  describe('createLanceMech', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/lances/lance-1/mechs',
  ...
  describe('updateLanceMech', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/lances/lance-1/mechs/m1',
