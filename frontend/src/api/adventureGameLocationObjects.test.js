...
import {
  fetchAdventureGameLocationObjects,
  createAdventureGameLocationObject,
  updateAdventureGameLocationObject,
  deleteAdventureGameLocationObject,
} from './adventureGameLocationObjects'
...
describe('locationObjects API', () => {
  ...
  describe('fetchAdventureGameLocationObjects', () => {
    it('calls GET /api/v1/adventure-games/:gameId/location-objects and returns data with hasMore', async () => {
      ...
      const result = await fetchAdventureGameLocationObjects('game-1')
  ...
  describe('createAdventureGameLocationObject', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      const result = await createAdventureGameLocationObject('game-1', data)
  ...
  describe('updateAdventureGameLocationObject', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      const result = await updateAdventureGameLocationObject('game-1', 'obj1', data)
  ...
  describe('deleteAdventureGameLocationObject', () => {
    it('sends DELETE and returns void', async () => {
      mockApiFetch.mockResolvedValue({ ok: true })

      await deleteAdventureGameLocationObject('game-1', 'obj1')
