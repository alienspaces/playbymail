 ...
 */
export async function uploadCreatureImage(gameId, creatureId, imageFile) {
 ...
 */
export async function getCreatureImage(gameId, creatureId) {
    const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${gameId}/creatures/${creatureId}/image`, {
 ...
 */
export async function deleteCreatureImage(gameId, creatureId) {
    const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${gameId}/creatures/${creatureId}/image`, {
        method: 'DELETE',
        headers: { ...getAuthHeaders() },
    });
