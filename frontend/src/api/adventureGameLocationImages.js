 ...
 */
export async function uploadAdventureGameLocationTurnSheetImage(gameId, locationId, imageFile) {
 ...
 */
export async function getAdventureGameLocationTurnSheetImage(gameId, locationId) {
    const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${gameId}/locations/${locationId}/turn-sheet-image`, {
 ...
 */
export async function deleteAdventureGameLocationTurnSheetImage(gameId, locationId) {
    const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${gameId}/locations/${locationId}/turn-sheet-image`, {
        method: 'DELETE',
        headers: { ...getAuthHeaders() },
    });
 ...
 */
export function getAdventureGameLocationChoiceTurnSheetPreviewUrl(gameId, locationId) {
