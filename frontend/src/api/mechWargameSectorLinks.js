...
const BASE = (gameId) => `${baseUrl}/api/v1/mech-wargame-games/${encodeURIComponent(gameId)}/sector-links`

export async function fetchSectorLinks(gameId, params = {}) {
...
export async function createSectorLink(gameId, data) {
...
export async function updateSectorLink(gameId, sectorLinkId, data) {
...
export async function deleteSectorLink(gameId, sectorLinkId) {
  const res = await apiFetch(`${BASE(gameId)}/${encodeURIComponent(sectorLinkId)}`, {
    method: 'DELETE',
