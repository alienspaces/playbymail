...
import { fetchSectors, createSector, updateSector, deleteSector } from './mechWargameSectors'

describe('mechWargameSectors API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('fetchSectors', () => {
    it('calls GET /api/v1/mech-wargame-games/:gameId/sectors and returns data with hasMore', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/v1/mech-wargame-games/game-1/sectors'),
  ...
  describe('createSector', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/sectors',
  ...
  describe('updateSector', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/sectors/s1',
