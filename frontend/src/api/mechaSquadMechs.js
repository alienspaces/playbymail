...
export async function fetchSquadMechs(gameId, squadId, params = {}) {
...
export async function createSquadMech(gameId, squadId, data) {
...
export async function updateSquadMech(gameId, squadId, mechId, data) {
...
export async function deleteSquadMech(gameId, squadId, mechId) {
  const res = await apiFetch(`${BASE(gameId, squadId)}/${encodeURIComponent(mechId)}`, {
    method: 'DELETE',
