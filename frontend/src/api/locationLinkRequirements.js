 ...
 */
export async function fetchLocationLinkRequirements(gameId, params = {}) {
 ...
 * @returns {Promise<GameLocationLinkRequirement>}
 */
export async function createLocationLinkRequirement(gameId, data) {
 ...
 * @returns {Promise<GameLocationLinkRequirement>}
 */
export async function updateLocationLinkRequirement(gameId, requirementId, data) {
 ...
 */
export async function deleteLocationLinkRequirement(gameId, requirementId) {
  const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${encodeURIComponent(gameId)}/location-link-requirements/${encodeURIComponent(requirementId)}`, {
    method: 'DELETE',
    headers: { ...getAuthHeaders() },
  });
