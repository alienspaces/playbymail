...
import {
  fetchAdventureGameLocationObjectEffects,
  createAdventureGameLocationObjectEffect,
  updateAdventureGameLocationObjectEffect,
  deleteAdventureGameLocationObjectEffect,
} from './adventureGameLocationObjectEffects'
...
describe('locationObjectEffects API', () => {
  ...
  describe('fetchAdventureGameLocationObjectEffects', () => {
    it('calls GET /api/v1/adventure-games/:gameId/location-object-effects and returns data with hasMore', async () => {
      ...
      const result = await fetchAdventureGameLocationObjectEffects('game-1')
  ...
  describe('createAdventureGameLocationObjectEffect', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      const result = await createAdventureGameLocationObjectEffect('game-1', data)
  ...
  describe('updateAdventureGameLocationObjectEffect', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      const result = await updateAdventureGameLocationObjectEffect('game-1', 'eff1', data)
  ...
  describe('deleteAdventureGameLocationObjectEffect', () => {
    it('sends DELETE and returns void', async () => {
      mockApiFetch.mockResolvedValue({ ok: true })

      await deleteAdventureGameLocationObjectEffect('game-1', 'eff1')
