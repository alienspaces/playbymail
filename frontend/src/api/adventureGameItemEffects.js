 ...
 */
export async function fetchAdventureGameItemEffects(gameId, params = {}) {
 ...
 * @returns {Promise<GameItemEffect>}
 */
export async function createAdventureGameItemEffect(gameId, data) {
 ...
 * @returns {Promise<GameItemEffect>}
 */
export async function updateAdventureGameItemEffect(gameId, itemEffectId, data) {
 ...
 */
export async function deleteAdventureGameItemEffect(gameId, itemEffectId) {
  const res = await apiFetch(`${baseUrl}/api/v1/adventure-games/${encodeURIComponent(gameId)}/item-effects/${encodeURIComponent(itemEffectId)}`, {
    method: 'DELETE',
    headers: { ...getAuthHeaders() },
  });
