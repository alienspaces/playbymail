...
import { fetchWeapons, createWeapon, updateWeapon, deleteWeapon } from './mechWargameWeapons'

describe('mechWargameWeapons API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('fetchWeapons', () => {
    it('calls GET /api/v1/mech-wargame-games/:gameId/weapons and returns data with hasMore', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/v1/mech-wargame-games/game-1/weapons'),
  ...
  describe('createWeapon', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/weapons',
  ...
  describe('updateWeapon', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/weapons/w1',
