...
import { fetchChassis, createChassis, updateChassis, deleteChassis } from './mechWargameChassis'

describe('mechWargameChassis API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('fetchChassis', () => {
    it('calls GET /api/v1/mech-wargame-games/:gameId/chassis and returns data with hasMore', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/v1/mech-wargame-games/game-1/chassis'),
  ...
  describe('createChassis', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/chassis',
  ...
  describe('updateChassis', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mech-wargame-games/game-1/chassis/ch1',
