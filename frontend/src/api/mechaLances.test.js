...
import { fetchLances, createLance, updateLance, deleteLance } from './mechaLances'

describe('mechaLances API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('fetchLances', () => {
    it('calls GET /api/v1/mecha-games/:gameId/lances and returns data with hasMore', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/v1/mecha-games/game-1/lances'),
  ...
  describe('createLance', () => {
    it('sends POST with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mecha-games/game-1/lances',
  ...
  describe('updateLance', () => {
    it('sends PUT with data and returns json.data', async () => {
      ...
      expect(mockApiFetch).toHaveBeenCalledWith(
        'http://localhost:8080/api/v1/mecha-games/game-1/lances/l1',
