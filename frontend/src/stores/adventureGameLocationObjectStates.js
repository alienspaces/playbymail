...
import {
  fetchAdventureGameLocationObjectStates as apiFetchStates,
  createAdventureGameLocationObjectState as apiCreateState,
  updateAdventureGameLocationObjectState as apiUpdateState,
  deleteAdventureGameLocationObjectState as apiDeleteState,
} from '../api/adventureGameLocationObjectStates';

export const useAdventureGameLocationObjectStatesStore = defineStore('adventureGameLocationObjectStates', {
  state: () => ({
